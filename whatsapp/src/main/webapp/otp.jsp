...
<form action="otp" method="post">
  <div class="mb-3" style="width:300px">
    ...
    <input type="number" name="otp" class="form-control" aria-describedby="emailHelp">
  </div>
  <br>
  <a type="submit" class="btn btn-primary" href="success.jsp">Submit OTP</a>
  <a type="button" class="btn btn-danger"  href="create.jsp ">Cancel</a>
